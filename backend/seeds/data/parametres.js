...
Alors si toi aussi, tu souhaites repousser tes limites, sortir de ta zone de confort, FONCE et comme je dis souvent "laisse tes rêves prendre de la hauteur".`,
  ...
  },
  {
    ...
    type: "texte",
    categorie: "interface",
    description: "Forme juridique (Auto-entrepreneur, SARL, etc.)",
    estModifiable: true,
  },
  {
    cle: "siren",
  ...
  {
    cle: "representantlegal",
    valeur: "",
    type: "texte",
    categorie: "interface",
    description: "Nom et prénom du représentant légal",
    estModifiable: true,
  },
  {
    cle: "telephonelegal",
    ...
    type: "texte",
    categorie: "interface",
    description: "Téléphone mentions légales",
    estModifiable: true,
  },
  {
    cle: "emaillegal",
    ...
    type: "texte",
    categorie: "interface",
    description: "Email mentions légales",
    estModifiable: true,
  },
  {
    cle: "hebergeurnom",
  ...
  {
    cle: "hebergeuradresse",
    valeur: "",
    type: "texte",
    categorie: "interface",
    description: "Adresse de l'hébergeur du site",
    estModifiable: true,
  },
  {
